...
export class GeneralserviceService {
  ...
  getState() {
    return this.http.post(environment.apiUrl+'/apigetstate',{id:'admin'});
  }
  getDistrictbyid(value:any){
    return this.http.post(environment.apiUrl+'/apigetdisrictbystateid',{state_id:value});
  }


  getChart(){
    this.http.post(environment.apiUrl + '/apiget_chart_data',{shop_id:'Myp000281'}).subscribe((response:any) => {
     if(response.status=='SUCCESS'){
       this.TotalOrdersPermonth=response['total_orderpermonth'];
       for(let x of this.TotalOrdersPermonth ){
         this.Lables.push(x['month'])
         this.Data.push(x['total_orders'])
